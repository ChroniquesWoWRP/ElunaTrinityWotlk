...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void Say(std::string_view text, Language language, float radius, WorldObject const* = nullptr) override;
        void Say(uint32 textId, WorldObject const* target = nullptr) override;
        /// Handles yelled message in regular chat based on declared language and in config pre-defined Range.
        void Yell(std::string_view text, Language language, WorldObject const* = nullptr) override;
        void Yell(std::string_view text, Language language, float radius, WorldObject const* = nullptr) override;
        ...
        void TextEmote(std::string_view text, float radius, WorldObject const* = nullptr, bool = false) override;
